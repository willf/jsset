...
(function() {
  ...
  describe("Uniq", function() {
    it('should uniqify a set', function() {
      var item, p, s, _i, _len;
      s = [1, 1, 2, 1, 1, 1, 1, 2];
      p = uniq(s);
      ...
      return expect(p.length).toBe(2);
    });
    it('should uniqify an empty sett', function() {
      var p, s;
      s = [];
      p = uniq(s);
      return expect(p.length).toBe(0);
    });
    return it('should uniqify a set of strings', function() {
      var item, p, s, _i, _len;
      s = ["a", "b", "b", "a"];
      p = uniq(s);
      for (_i = 0, _len = s.length; _i < _len; _i++) {
